...
def generate_caption_from_apps_screenshots(apps : list, filename = Config.APPS_IMAGE_CAPTIONS_FILENAME, model_name="Qwen/Qwen2VL-7B-Instruct", device="cuda" if torch.cuda.is_available() else "cpu"):
